...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/BMS_PROJECT/MARVEL-BMS/Marvel-III/sourceCode/xpack-openocd-0.11.0-4/bin/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/BMS_PROJECT/MARVEL-BMS/Marvel-III/sourceCode/xpack-openocd-0.11.0-4/bin/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt;  mass_erase 0; exit"
